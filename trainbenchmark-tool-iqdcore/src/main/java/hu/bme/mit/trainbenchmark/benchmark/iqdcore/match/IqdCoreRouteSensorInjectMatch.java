...
public class IqdCoreRouteSensorInjectMatch extends IqdCoreMatch implements RouteSensorInjectMatch {

	public IqdCoreRouteSensorInjectMatch(final Vector<Object> qs) {
		super(qs);
	}
