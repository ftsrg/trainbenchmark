...
public class IqdCoreSwitchSetInjectMatch extends IqdCoreMatch implements SwitchSetInjectMatch {

	public IqdCoreSwitchSetInjectMatch(final Vector<Object> qs) {
		super(qs);
	}
