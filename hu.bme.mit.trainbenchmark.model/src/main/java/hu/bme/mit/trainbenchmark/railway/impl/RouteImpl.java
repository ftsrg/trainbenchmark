 ...
 * <ul>
 *   <li>{@link hu.bme.mit.trainbenchmark.railway.impl.RouteImpl#getRoute_entry <em>Route entry</em>}</li>
 *   <li>{@link hu.bme.mit.trainbenchmark.railway.impl.RouteImpl#getRoute_switchPosition <em>Route switch Position</em>}</li>
 *   <li>{@link hu.bme.mit.trainbenchmark.railway.impl.RouteImpl#getRoute_exit <em>Route exit</em>}</li>
 *   <li>{@link hu.bme.mit.trainbenchmark.railway.impl.RouteImpl#getRoute_routeDefinition <em>Route route Definition</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RouteImpl extends ThingImpl implements Route {
		...
		if (route_entry != null && route_entry.eIsProxy()) {
			...
			if (route_entry != oldRoute_entry) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RailwayPackage.ROUTE__ROUTE_ENTRY, oldRoute_entry, route_entry));
			}
		}
		return route_entry;
	}
	...
	public void setRoute_entry(Signal newRoute_entry) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RailwayPackage.ROUTE__ROUTE_ENTRY, oldRoute_entry, route_entry));
	}
	...
	public EList<SwitchPosition> getRoute_switchPosition() {
		if (route_switchPosition == null) {
			route_switchPosition = new EObjectWithInverseResolvingEList<SwitchPosition>(SwitchPosition.class, this, RailwayPackage.ROUTE__ROUTE_SWITCH_POSITION, RailwayPackage.SWITCH_POSITION__SWITCH_POSITION_ROUTE);
		}
	...
	public Signal getRoute_exit() {
		if (route_exit != null && route_exit.eIsProxy()) {
			...
			if (route_exit != oldRoute_exit) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RailwayPackage.ROUTE__ROUTE_EXIT, oldRoute_exit, route_exit));
			}
		}
		return route_exit;
	}
	...
	public void setRoute_exit(Signal newRoute_exit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RailwayPackage.ROUTE__ROUTE_EXIT, oldRoute_exit, route_exit));
	}
	...
	public EList<Sensor> getRoute_routeDefinition() {
		if (route_routeDefinition == null) {
			route_routeDefinition = new EObjectResolvingEList<Sensor>(Sensor.class, this, RailwayPackage.ROUTE__ROUTE_ROUTE_DEFINITION);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RailwayPackage.ROUTE__ROUTE_SWITCH_POSITION:
