 ...
 * <ul>
 *   <li>{@link Concept.impl.TrackElementImpl#getTrackElement_sensor <em>Track Element sensor</em>}</li>
 *   <li>{@link Concept.impl.TrackElementImpl#getTrackElement_connectsTo <em>Track Element connects To</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TrackElementImpl extends ThingImpl implements TrackElement {
	...
	protected EClass eStaticClass() {
		return ConceptPackage.Literals.TRACK_ELEMENT;
	}
	...
	public EList<Sensor> getTrackElement_sensor() {
		if (trackElement_sensor == null) {
			trackElement_sensor = new EObjectWithInverseResolvingEList.ManyInverse<Sensor>(Sensor.class, this, ConceptPackage.TRACK_ELEMENT__TRACK_ELEMENT_SENSOR, ConceptPackage.SENSOR__SENSOR_TRACK_ELEMENT);
		}
	...
	public EList<TrackElement> getTrackElement_connectsTo() {
		if (trackElement_connectsTo == null) {
			trackElement_connectsTo = new EObjectResolvingEList<TrackElement>(TrackElement.class, this, ConceptPackage.TRACK_ELEMENT__TRACK_ELEMENT_CONNECTS_TO);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ConceptPackage.TRACK_ELEMENT__TRACK_ELEMENT_SENSOR:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ConceptPackage.TRACK_ELEMENT__TRACK_ELEMENT_CONNECTS_TO:
