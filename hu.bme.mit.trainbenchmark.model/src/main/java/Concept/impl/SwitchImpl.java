 ...
 * <ul>
 *   <li>{@link Concept.impl.SwitchImpl#getSwitch_actualState <em>Switch actual State</em>}</li>
 *   <li>{@link Concept.impl.SwitchImpl#getSwitch_switchPosition <em>Switch switch Position</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SwitchImpl extends TrackElementImpl implements Switch {
	...
	public void setSwitch_actualState(SwitchStateKind newSwitch_actualState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConceptPackage.SWITCH__SWITCH_ACTUAL_STATE, oldSwitch_actualState, switch_actualState));
	}
	...
	public EList<SwitchPosition> getSwitch_switchPosition() {
		if (switch_switchPosition == null) {
			switch_switchPosition = new EObjectWithInverseResolvingEList<SwitchPosition>(SwitchPosition.class, this, ConceptPackage.SWITCH__SWITCH_SWITCH_POSITION, ConceptPackage.SWITCH_POSITION__SWITCH_POSITION_SWITCH);
		}
