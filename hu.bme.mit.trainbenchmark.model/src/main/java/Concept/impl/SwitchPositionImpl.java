 ...
 * <ul>
 * <li>{@link Concept.impl.SwitchPositionImpl#getSwitchPosition_switch <em>
 * Switch Position switch</em>}</li>
 * <li>{@link Concept.impl.SwitchPositionImpl#getSwitchPosition_switchState <em>
 * Switch Position switch State</em>}</li>
 * <li>{@link Concept.impl.SwitchPositionImpl#getSwitchPosition_route <em>Switch
 * Position route</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class SwitchPositionImpl extends ThingImpl implements SwitchPosition {
	/**
	 * The cached value of the '{@link #getSwitchPosition_switch()
	...
	/**
	 * The default value of the '{@link #getSwitchPosition_switchState()
	...
	/**
	 * The cached value of the '{@link #getSwitchPosition_switchState()
	 * <em>Switch Position switch State</em>}' attribute. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @see #getSwitchPosition_switchState()
	...
	/**
	 * The cached value of the '{@link #getSwitchPosition_route()
		...
		if (switchPosition_switch != null && switchPosition_switch.eIsProxy()) {
			...
			if (switchPosition_switch != oldSwitchPosition_switch) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ConceptPackage.SWITCH_POSITION__SWITCH_POSITION_SWITCH,
							oldSwitchPosition_switch, switchPosition_switch));
			}
		}
	...
	public NotificationChain basicSetSwitchPosition_switch(Switch newSwitchPosition_switch, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ConceptPackage.SWITCH_POSITION__SWITCH_POSITION_SWITCH, oldSwitchPosition_switch, newSwitchPosition_switch);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setSwitchPosition_switch(Switch newSwitchPosition_switch) {
		if (newSwitchPosition_switch != switchPosition_switch) {
			...
			if (switchPosition_switch != null)
				msgs = ((InternalEObject) switchPosition_switch).eInverseRemove(this, ConceptPackage.SWITCH__SWITCH_SWITCH_POSITION,
						Switch.class, msgs);
			if (newSwitchPosition_switch != null)
				msgs = ((InternalEObject) newSwitchPosition_switch).eInverseAdd(this, ConceptPackage.SWITCH__SWITCH_SWITCH_POSITION,
						Switch.class, msgs);
			msgs = basicSetSwitchPosition_switch(newSwitchPosition_switch, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConceptPackage.SWITCH_POSITION__SWITCH_POSITION_SWITCH,
					newSwitchPosition_switch, newSwitchPosition_switch));
	}
	...
	public void setSwitchPosition_switchState(SwitchStateKind newSwitchPosition_switchState) {
		...
		switchPosition_switchState = newSwitchPosition_switchState == null ? SWITCH_POSITION_SWITCH_STATE_EDEFAULT
				: newSwitchPosition_switchState;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConceptPackage.SWITCH_POSITION__SWITCH_POSITION_SWITCH_STATE,
					oldSwitchPosition_switchState, switchPosition_switchState));
	}
	...
	public Route getSwitchPosition_route() {
		if (switchPosition_route != null && switchPosition_route.eIsProxy()) {
			...
			if (switchPosition_route != oldSwitchPosition_route) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ConceptPackage.SWITCH_POSITION__SWITCH_POSITION_ROUTE,
							oldSwitchPosition_route, switchPosition_route));
			}
		}
	...
	public NotificationChain basicSetSwitchPosition_route(Route newSwitchPosition_route, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ConceptPackage.SWITCH_POSITION__SWITCH_POSITION_ROUTE, oldSwitchPosition_route, newSwitchPosition_route);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setSwitchPosition_route(Route newSwitchPosition_route) {
		if (newSwitchPosition_route != switchPosition_route) {
			...
			if (switchPosition_route != null)
				msgs = ((InternalEObject) switchPosition_route).eInverseRemove(this, ConceptPackage.ROUTE__ROUTE_SWITCH_POSITION,
						Route.class, msgs);
			if (newSwitchPosition_route != null)
				msgs = ((InternalEObject) newSwitchPosition_route).eInverseAdd(this, ConceptPackage.ROUTE__ROUTE_SWITCH_POSITION,
						Route.class, msgs);
			msgs = basicSetSwitchPosition_route(newSwitchPosition_route, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConceptPackage.SWITCH_POSITION__SWITCH_POSITION_ROUTE,
					newSwitchPosition_route, newSwitchPosition_route));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case ConceptPackage.SWITCH_POSITION__SWITCH_POSITION_SWITCH:
			if (resolve)
				return getSwitchPosition_switch();
		...
		case ConceptPackage.SWITCH_POSITION__SWITCH_POSITION_ROUTE:
			if (resolve)
				return getSwitchPosition_route();
