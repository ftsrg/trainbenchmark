 ...
 * <ul>
 *   <li>{@link Concept.TrackElement#getTrackElement_sensor <em>Track Element sensor</em>}</li>
 *   <li>{@link Concept.TrackElement#getTrackElement_connectsTo <em>Track Element connects To</em>}</li>
 * </ul>
 * </p>
 *
...
public interface TrackElement extends Thing {
	 ...
	 * It is bidirectional and its opposite is '{@link Concept.Sensor#getSensor_trackElement <em>Sensor track Element</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
