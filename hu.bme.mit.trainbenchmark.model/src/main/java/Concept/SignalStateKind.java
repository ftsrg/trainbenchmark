 ...
 * <em><b>Signal State Kind</b></em>', and utility methods for working with
 * them. <!-- end-user-doc -->
 * 
 * @see Concept.ConceptPackage#getSignalStateKind()
 * @model
 * @generated
 */
public enum SignalStateKind implements Enumerator {
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>Signal State Kind STOP</b></em>' literal object
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>Signal State Kind FAILURE</b></em>' literal
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>Signal State Kind GO</b></em>' literal object
	 * isn't clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * @generated
	 */
	private static final SignalStateKind[] VALUES_ARRAY = new SignalStateKind[] { SIGNAL_STATE_KIND_STOP, SIGNAL_STATE_KIND_FAILURE,
			SIGNAL_STATE_KIND_GO, };

	/**
	 * A public read-only list of all the '<em><b>Signal State Kind</b></em>'
	...
	/**
	 * Returns the '<em><b>Signal State Kind</b></em>' literal with the
	...
	public static SignalStateKind get(int value) {
		switch (value) {
		case SIGNAL_STATE_KIND_STOP_VALUE:
			return SIGNAL_STATE_KIND_STOP;
		case SIGNAL_STATE_KIND_FAILURE_VALUE:
			return SIGNAL_STATE_KIND_FAILURE;
		case SIGNAL_STATE_KIND_GO_VALUE:
			return SIGNAL_STATE_KIND_GO;
		}
		return null;
	}
