 ...
 * @generated
 */
public class ConceptAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected ConceptSwitch<Adapter> modelSwitch = new ConceptSwitch<Adapter>() {
		@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link Concept.Segment
	 ...
	 * {@link Concept.Trackelement <em>Trackelement</em>}'. <!-- begin-user-doc
	...
	/**
	 * Creates a new adapter for an object of class '{@link Concept.Switch
	...
	/**
	 * Creates a new adapter for an object of class '{@link Concept.Route
	 * <em>Route</em>}'. <!-- begin-user-doc --> This default implementation
	 * returns null so that we can easily ignore cases; it's useful to ignore a
	 * case when inheritance will catch all the cases anyway. <!-- end-user-doc
	 * -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class '{@link Concept.Signal
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link Concept.SwitchPosition <em>Switch Position</em>}'. <!--
	...
	/**
	 * Creates a new adapter for an object of class '{@link Concept.Thing
	 * <em>Thing</em>}'. <!-- begin-user-doc --> This default implementation
	 * returns null so that we can easily ignore cases; it's useful to ignore a
	 * case when inheritance will catch all the cases anyway. <!-- end-user-doc
	 * -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class '{@link Concept.Sensor
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link Concept.IndividualContainer <em>Individual Container</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we
	 * can easily ignore cases; it's useful to ignore a case when inheritance
	 * will catch all the cases anyway. <!-- end-user-doc -->
	 * 
