...
public class Rdf4jDriver extends RdfDriver<IRI> {
	...
	public void deleteSingleOutgoingEdge(final Collection<IRI> vertices, final String vertexType, final String edgeType)
			throws RepositoryException {
		deleteEdges(vertices, edgeType, true, false);
	}
	
	public void deleteOutgoingEdges(final Collection<IRI> vertices, final String vertexType, final String edgeType)
			throws RepositoryException {
