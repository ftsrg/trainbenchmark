...
import hu.bme.mit.trainbenchmark.benchmark.viatra.util.RouteSensorInjectProcessor;
...
public class RouteSensorInjectMatcher extends BaseMatcher<RouteSensorInjectMatch> {
  ...
  public static RouteSensorInjectMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    ...
    if (matcher == null) {
    	matcher = new RouteSensorInjectMatcher(engine);
   ...
   * 
   */
  private RouteSensorInjectMatcher(final ViatraQueryEngine engine) throws ViatraQueryException {
