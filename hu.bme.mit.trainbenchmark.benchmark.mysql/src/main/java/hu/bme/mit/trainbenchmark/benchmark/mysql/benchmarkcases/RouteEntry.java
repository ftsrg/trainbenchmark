...
public class RouteEntry extends MySQLBenchmarkCase {
	...
	public void check() throws IOException {
		...
		try (ResultSet rs = con.createStatement().executeQuery("SELECT id, Route_entry FROM trainbenchmark.Route WHERE Route_entry != 0;")) {
