...
public class GraphflowSwitchMonitoredInjectMatch extends GraphflowMatch implements SwitchMonitoredInjectMatch {

	public GraphflowSwitchMonitoredInjectMatch(final Map<String, Object> match) {
		super(match);
	}
