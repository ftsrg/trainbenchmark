...
public class OneTimeMatchQueryGroupByTests {
    ...
    private void constructTestGraph() {
        ...
        final String createQuery = "CREATE " +
    ...
    public void testAggregateNoGroupByKeyOneAggregation() {
        final String queryString = "MATCH (a)->(b) return sum(b.intVP)";
    ...
    public void testAggregateNoGroupByKeyMultipleAggregations() {
        final String queryString = "MATCH (a)->(b) return sum(b.intVP), avg(a.doubleVP)";
    ...
    public void testAggregateSingleGroupByKeySingleAggregation() {
        final String queryString = "MATCH (a)-[e:CycleEdge]->(b) return b.strVP, avg(e.intEP)";
        ...
        final double strOAvg = (double) (5 + 9 + 6) / 3;
        final double strEAvg = (double) (3 + 7) / 2;
        runTest(queryString, "strVPValueO " + strOAvg, "strVPValueE " + strEAvg);
    }

    @Test
    public void testAggregateSingleGroupByKeyMultipleAggregation() {
        final String queryString = "MATCH (a)-[e:CycleEdge]->(b) return b.strVP, avg(e.intEP), count(*)";
        // see testAggregateSingleGroupByKeySingleAggregation
        final double strVPValueOAvg = (double) (5 + 9 + 6) / 3;
        final double strVPValueEAvg = (double) (3 + 7) / 2;
        runTest(queryString, "strVPValueO " + strVPValueOAvg + " 3", "strVPValueE " +
            strVPValueEAvg + " 2");
    }

    @Test
    public void testAggregateMultipleGroupByKeySingleAggregation() {
        final String queryString = "MATCH (a)-[e:CycleEdge]->(b) return a.strVP, e.strEP, " +
            "sum(b.doubleVP)";
    ...
    public void testAggregateMultipleGroupByKeyMultipleAggregations() {
        final String queryString = "MATCH (a)-[e:CycleEdge]->(b) return a.strVP, e.strEP, sum(b" +
            ".doubleVP), count(*)";
    ...
    public void testCountStar() {
        final String queryString = "MATCH (a)->(b) return count(*)";
        runTest(queryString, " 10");
    }

    @Test
    public void testAverageInt() {
        final String queryString = "MATCH (a)-[e]->(b) return e.strEP, avg(b.intVP);";
        ...
        final double strEPValueOAvg = (1 + 3 + 5 + 2 + 3 + 4 + 5) / 7.0;
        final double strEPValueEAvg = (2 + 4 + 1) / 3.0;
        runTest(queryString, "strEPValueO " + strEPValueOAvg, "strEPValueE " + strEPValueEAvg);
    }

    @Test
    public void testAverageDouble() {
        final String queryString = "MATCH (a)-[e]->(b) return e.strEP, avg(a.doubleVP);";
        ...
        final double strEPValueOAvg = (0.0 + 0.0 + 0.0 + 1.0 + 2.0 + 3.0 + 4.0) / 7;
        final double strEPValueEAvg = (0.0 + 0.0 + 5.0) / 3;
        runTest(queryString, "strEPValueO " + strEPValueOAvg, "strEPValueE " + strEPValueEAvg);
    }

    @Test
    public void testSumInt() {
        final String queryString = "MATCH (a)-[e]->(b) return e.strEP, sum(b.intVP);";
        // see testAverageInt
        final long strEPValueOSum = 1 + 3 + 5 + 2 + 3 + 4 + 5;
        final long strEPValueESum = 2 + 4 + 1;
        runTest(queryString, "strEPValueO " + strEPValueOSum, "strEPValueE " + strEPValueESum);
    }

    @Test
    public void testSumDouble() {
        final String queryString = "MATCH (a)-[e]->(b) return e.strEP, sum(a.doubleVP);";
        // see testAverageDouble
        final double strEPValueOSum = 0.0 + 0.0 + 0.0 + 1.0 + 2.0 + 3.0 + 4.0;
        final double strEPValueESum = 0.0 + 0.0 + 5.0;
        runTest(queryString, "strEPValueO " + strEPValueOSum, "strEPValueE " + strEPValueESum);
    }

    @Test
    public void testMaxInt() {
        final String queryString = "MATCH (a)-[e]->(b) return a.strVP, max(e.intEP);";
        ...
        final long strVPValueOMax = 7;
        final long strVPValueEMax = 9;
        runTest(queryString, "strVPValueO " + strVPValueOMax, "strVPValueE " + strVPValueEMax);
    }

    @Test
    public void testMaxDouble() {
        final String queryString = "MATCH (a)-[e]->(b) return e.strEP, max(a.doubleVP);";
        // see testAverageDouble
        final double strEPValueOMax = 4.0;
        final double strEPValueEMax = 5.0;
        runTest(queryString, "strEPValueO " + strEPValueOMax, "strEPValueE " + strEPValueEMax);
    }

    @Test
    public void testMinInt() {
        final String queryString = "MATCH (a)-[e]->(b) return a.strVP, min(e.intEP);";
        // see testMaxInt
        final long strVPValueOMin = 3;
        final long strVPValueEMin = 1;
        runTest(queryString, "strVPValueO " + strVPValueOMin, "strVPValueE " + strVPValueEMin);
    }

    @Test
    public void testMinDouble() {
        final String queryString = "MATCH (a)-[e]->(b) return e.strEP, min(a.doubleVP);";
        // see testAverageDouble
        final double strEPValueOMax = 0.0;
        final double strEPValueEMax = 0.0;
        runTest(queryString, "strEPValueO " + strEPValueOMax, "strEPValueE " + strEPValueEMax);
    }

    private void runTest(final String queryString, final String... expectedResultsList) {
        final StructuredQuery query = new StructuredQueryParser().parse(queryString);
        ...
        final List<String> expectedResults = new ArrayList<>(Arrays.asList(expectedResultsList));
        final List<String> actualResults = outputSink.getResults();
