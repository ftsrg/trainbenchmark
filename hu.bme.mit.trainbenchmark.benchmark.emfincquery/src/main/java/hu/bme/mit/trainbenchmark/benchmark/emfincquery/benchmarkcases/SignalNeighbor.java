...
public class SignalNeighbor extends EMFIncQueryBenchmarkCase<Route> {
	...
	public void load() throws IOException {
		...
		try {
			...
			SignalNeighborMatcher patternMatcher = SignalNeighborMatcher.on(engine);
			iqDeltaMonitor = new IQDeltaMonitor<Route>(patternMatcher, "R1");
	...
	public void check() {
		bmr.startStopper();
		invalids = new ArrayList<Route>(iqDeltaMonitor.getMatching());
