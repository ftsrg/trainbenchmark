...
public class TinkerGraphBenchmarkCase
		extends AbstractBenchmarkCase<TinkerGraphMatch, Vertex, TinkerGraphDriver, BenchmarkConfigWrapper> {

	@Override
	public TinkerGraphDriver createDriver(final BenchmarkConfigWrapper benchmarkConfigWrapper) throws Exception {
