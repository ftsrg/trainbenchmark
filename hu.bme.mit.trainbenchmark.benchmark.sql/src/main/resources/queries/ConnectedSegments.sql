...
INNER JOIN connectsTo as ct6 ON ct5.TrackElement2 = ct6.TrackElement1
INNER JOIN TrackElement as te1 ON Segment.id = te1.id
INNER JOIN TrackElement as te2 ON ct6.TrackElement1 = te2.id
