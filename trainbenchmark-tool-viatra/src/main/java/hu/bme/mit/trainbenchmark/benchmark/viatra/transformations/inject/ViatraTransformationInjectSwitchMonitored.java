...
public class ViatraTransformationInjectSwitchMonitored extends ViatraTransformation<SwitchMonitoredInjectMatch> {

	public ViatraTransformationInjectSwitchMonitored(final ViatraDriver driver) {
		super(driver);
	}

	@Override
	public void activate(final Collection<SwitchMonitoredInjectMatch> matches) throws IOException {
		for (final SwitchMonitoredInjectMatch match : matches) {
