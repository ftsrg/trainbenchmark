...
public class ViatraQueryActiveRoute extends ViatraQuery<ActiveRouteMatch> {

	public ViatraQueryActiveRoute(final ViatraDriver driver) {
		super(RailwayQuery.ACTIVEROUTE, driver);
	}

	@Override
	public ViatraQueryMatcher<ActiveRouteMatch> getMatcher() throws ViatraQueryException {
		return engine.getMatcher(ActiveRouteQuerySpecification.instance());
	}
