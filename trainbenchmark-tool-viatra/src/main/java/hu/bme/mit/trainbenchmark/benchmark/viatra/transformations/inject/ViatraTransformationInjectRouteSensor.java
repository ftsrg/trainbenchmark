...
public class ViatraTransformationInjectRouteSensor extends ViatraTransformation<RouteSensorInjectMatch> {

	public ViatraTransformationInjectRouteSensor(final ViatraDriver driver) {
		super(driver);
	}

	@Override
	public void activate(final Collection<RouteSensorInjectMatch> matches) throws IOException {
		for (final RouteSensorInjectMatch match : matches) {
