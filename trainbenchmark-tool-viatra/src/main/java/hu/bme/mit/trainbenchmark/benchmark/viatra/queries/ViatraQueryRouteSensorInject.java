...
public class ViatraQueryRouteSensorInject extends ViatraQuery<RouteSensorInjectMatch> {

	public ViatraQueryRouteSensorInject(final ViatraDriver driver) {
		super(RailwayQuery.ROUTESENSOR_INJECT, driver);
	}

	@Override
	public ViatraQueryMatcher<RouteSensorInjectMatch> getMatcher() throws ViatraQueryException {
		return engine.getMatcher(RouteSensorInjectQuerySpecification.instance());
	}
