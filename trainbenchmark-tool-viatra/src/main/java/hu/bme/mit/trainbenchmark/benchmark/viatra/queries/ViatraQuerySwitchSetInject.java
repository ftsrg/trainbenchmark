...
public class ViatraQuerySwitchSetInject extends ViatraQuery<SwitchSetInjectMatch> {

	public ViatraQuerySwitchSetInject(final ViatraDriver driver) {
		super(RailwayQuery.SWITCHSET_INJECT, driver);
	}

	@Override
	public ViatraQueryMatcher<SwitchSetInjectMatch> getMatcher() throws ViatraQueryException {
		return engine.getMatcher(SwitchSetInjectQuerySpecification.instance());
	}
