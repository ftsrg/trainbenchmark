...
mvn install:install-file \
       ...
       -Dpackaging=jar
mvn install:install-file \
       -Dfile=./hu.bme.mit.trainbenchmark.benchmark.virtuoso/src/main/resources/virtjdbc4.jar \
...
mvn install:install-file \
       ...
       -Dpackaging=jar
mvn install:install-file \
       -Dfile=./hu.bme.mit.trainbenchmark.benchmark.allegro/src/main/resources/commons-io-2.4.jar \
       -DgroupId=org.apache.commons \
       -DartifactId=commons.io -Dversion=2.4.0 \
       -Dpackaging=jar
mvn install:install-file \
       -Dfile=./hu.bme.mit.trainbenchmark.benchmark.allegro/src/main/resources/commons-pool-1.5.6.jar \
       -DgroupId=org.apache.commons \
       -DartifactId=commons.pool -Dversion=1.5.6 \
       -Dpackaging=jar
mvn install:install-file \
       -Dfile=./hu.bme.mit.trainbenchmark.benchmark.allegro/src/main/resources/commons-codec-1.3.jar \
       -DgroupId=org.apache.commons \
