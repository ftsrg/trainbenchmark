...
import hu.bme.mit.trainbenchmark.benchmark.drools.benchmarkcases.PosLength;
...
public class PosLengthXForm extends PosLength implements TransformationBenchmarkCase {
	...
	@Override
	public void modify() {
		EMFModification.modifyEMFmodelPosLengthRepair(pack, bmr, Util.calcModify(bc, bc.getModificationConstant(), bmr),
