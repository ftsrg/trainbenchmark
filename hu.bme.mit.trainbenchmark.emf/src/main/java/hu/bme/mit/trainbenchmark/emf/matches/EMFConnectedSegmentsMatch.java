...
public class EMFConnectedSegmentsMatch extends EMFMatch implements ConnectedSegmentsMatch {
	...
	public EMFConnectedSegmentsMatch(final Sensor sensor1, final Sensor sensor2, final Segment segment1, final Segment segment2,
			final Segment segment3, final Segment segment4, final Segment segment5, final Segment segment6) {
		super();
		match = new RailwayElement[] { sensor1, sensor2, segment1, segment2, segment3, segment4, segment5, segment6 };
	}
