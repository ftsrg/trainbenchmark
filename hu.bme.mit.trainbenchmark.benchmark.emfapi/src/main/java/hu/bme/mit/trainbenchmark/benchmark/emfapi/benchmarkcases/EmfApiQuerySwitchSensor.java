...
public class EmfApiQuerySwitchSensor<TDriver extends EmfDriver> extends EmfApiQuery<EmfSwitchSensorMatch, TDriver> {

	public EmfApiQuerySwitchSensor(final TDriver driver) {
		super(driver);
	}
