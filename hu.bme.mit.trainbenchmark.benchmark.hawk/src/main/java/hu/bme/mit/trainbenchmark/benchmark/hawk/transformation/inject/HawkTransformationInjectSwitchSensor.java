...
public class HawkTransformationInjectSwitchSensor extends EMFTransformationInjectSwitchSensor {

	public HawkTransformationInjectSwitchSensor(final HawkDriver driver) {
		super(driver);
	}
