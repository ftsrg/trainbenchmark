...
public class HawkTransformationRepairSwitchSensor extends EMFIncQueryTransformationRepairSwitchSensor {

	public HawkTransformationRepairSwitchSensor(final HawkDriver<?> driver) {
		super(driver);
	}
