...
public class HawkTransformationInjectPosLength extends EMFTransformationInjectPosLength {

	public HawkTransformationInjectPosLength(final HawkDriver driver) {
		super(driver);
	}
