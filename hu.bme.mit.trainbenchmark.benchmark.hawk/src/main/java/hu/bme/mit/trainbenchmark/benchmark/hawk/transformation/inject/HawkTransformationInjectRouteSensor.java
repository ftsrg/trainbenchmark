...
public class HawkTransformationInjectRouteSensor extends EMFTransformationInjectRouteSensor {

	public HawkTransformationInjectRouteSensor(final HawkDriver driver) {
		super(driver);
	}
