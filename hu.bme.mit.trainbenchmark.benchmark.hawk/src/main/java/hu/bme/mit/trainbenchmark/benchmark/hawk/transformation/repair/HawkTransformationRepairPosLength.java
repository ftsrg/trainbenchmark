...
public class HawkTransformationRepairPosLength extends EMFIncQueryTransformationRepairPosLength {

	public HawkTransformationRepairPosLength(final HawkDriver<?> driver) {
		super(driver);
	}
