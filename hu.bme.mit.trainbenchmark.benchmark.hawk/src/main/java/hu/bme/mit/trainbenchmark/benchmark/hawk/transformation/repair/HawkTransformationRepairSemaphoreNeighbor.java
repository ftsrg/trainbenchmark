...
public class HawkTransformationRepairSemaphoreNeighbor extends EMFIncQueryTransformationRepairSemaphoreNeighbor {

	public HawkTransformationRepairSemaphoreNeighbor(final HawkDriver<?> driver) {
		super(driver);
	}
