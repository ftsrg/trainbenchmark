...
public class HawkTransformationRepairRouteSensor extends EMFIncQueryTransformationRepairRouteSensor {

	public HawkTransformationRepairRouteSensor(final HawkDriver<?> driver) {
		super(driver);
	}
