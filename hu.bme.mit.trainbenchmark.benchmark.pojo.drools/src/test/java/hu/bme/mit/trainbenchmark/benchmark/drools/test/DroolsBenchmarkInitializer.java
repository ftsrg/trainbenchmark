...
import hu.bme.mit.trainbenchmark.benchmark.pojo.drools.DroolsPojoBenchmarkLogic;
...
public class DroolsBenchmarkInitializer extends BenchmarkInitializer {
	...
	protected GenericBenchmarkLogic initializeBenchmark(String queryName, String scenario) throws ParseException {
		...
		String[] args = {
				"-query", queryName, 
				"-benchmarkArtifact", "../models/railway-test-1.xml",
				"-scenario", scenario, 
				"-workspacePath", "../" 
			};
		// @formatter:on

		return new DroolsPojoBenchmarkLogic(args);
	}
