 ...
 * <ul>
 *   <li>{@link hu.bme.mit.trainbenchmark.railway.impl.SwitchPositionImpl#getSwitchPosition_switch <em>Switch Position switch</em>}</li>
 *   <li>{@link hu.bme.mit.trainbenchmark.railway.impl.SwitchPositionImpl#getSwitchPosition_switchState <em>Switch Position switch State</em>}</li>
 *   <li>{@link hu.bme.mit.trainbenchmark.railway.impl.SwitchPositionImpl#getSwitchPosition_route <em>Switch Position route</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SwitchPositionImpl extends RailwayElementImpl implements SwitchPosition {
	 ...
	 * @ordered
	 */
	protected static final SwitchState SWITCH_POSITION_SWITCH_STATE_EDEFAULT = SwitchState.FAILURE;
	 ...
	 * @ordered
	 */
	protected SwitchState switchPosition_switchState = SWITCH_POSITION_SWITCH_STATE_EDEFAULT;
		...
		if (switchPosition_switch != null && switchPosition_switch.eIsProxy()) {
			...
			if (switchPosition_switch != oldSwitchPosition_switch) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RailwayPackage.SWITCH_POSITION__SWITCH_POSITION_SWITCH, oldSwitchPosition_switch, switchPosition_switch));
			}
		}
	...
	public NotificationChain basicSetSwitchPosition_switch(Switch newSwitchPosition_switch, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RailwayPackage.SWITCH_POSITION__SWITCH_POSITION_SWITCH, oldSwitchPosition_switch, newSwitchPosition_switch);
	...
	public void setSwitchPosition_switch(Switch newSwitchPosition_switch) {
		if (newSwitchPosition_switch != switchPosition_switch) {
			...
			if (switchPosition_switch != null)
				msgs = ((InternalEObject)switchPosition_switch).eInverseRemove(this, RailwayPackage.SWITCH__SWITCH_SWITCH_POSITION, Switch.class, msgs);
			if (newSwitchPosition_switch != null)
				msgs = ((InternalEObject)newSwitchPosition_switch).eInverseAdd(this, RailwayPackage.SWITCH__SWITCH_SWITCH_POSITION, Switch.class, msgs);
			msgs = basicSetSwitchPosition_switch(newSwitchPosition_switch, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RailwayPackage.SWITCH_POSITION__SWITCH_POSITION_SWITCH, newSwitchPosition_switch, newSwitchPosition_switch));
	}
	 ...
	 * @generated
	 */
	public SwitchState getSwitchPosition_switchState() {
	 ...
	 * @generated
	 */
	public void setSwitchPosition_switchState(SwitchState newSwitchPosition_switchState) {
		SwitchState oldSwitchPosition_switchState = switchPosition_switchState;
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RailwayPackage.SWITCH_POSITION__SWITCH_POSITION_SWITCH_STATE, oldSwitchPosition_switchState, switchPosition_switchState));
	}
	...
	public Route getSwitchPosition_route() {
		if (switchPosition_route != null && switchPosition_route.eIsProxy()) {
			...
			if (switchPosition_route != oldSwitchPosition_route) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RailwayPackage.SWITCH_POSITION__SWITCH_POSITION_ROUTE, oldSwitchPosition_route, switchPosition_route));
			}
		}
	...
	public NotificationChain basicSetSwitchPosition_route(Route newSwitchPosition_route, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RailwayPackage.SWITCH_POSITION__SWITCH_POSITION_ROUTE, oldSwitchPosition_route, newSwitchPosition_route);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSwitchPosition_route(Route newSwitchPosition_route) {
		if (newSwitchPosition_route != switchPosition_route) {
			...
			if (switchPosition_route != null)
				msgs = ((InternalEObject)switchPosition_route).eInverseRemove(this, RailwayPackage.ROUTE__ROUTE_SWITCH_POSITION, Route.class, msgs);
			if (newSwitchPosition_route != null)
				msgs = ((InternalEObject)newSwitchPosition_route).eInverseAdd(this, RailwayPackage.ROUTE__ROUTE_SWITCH_POSITION, Route.class, msgs);
			msgs = basicSetSwitchPosition_route(newSwitchPosition_route, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RailwayPackage.SWITCH_POSITION__SWITCH_POSITION_ROUTE, newSwitchPosition_route, newSwitchPosition_route));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RailwayPackage.SWITCH_POSITION__SWITCH_POSITION_SWITCH:
				if (switchPosition_switch != null)
					msgs = ((InternalEObject)switchPosition_switch).eInverseRemove(this, RailwayPackage.SWITCH__SWITCH_SWITCH_POSITION, Switch.class, msgs);
				return basicSetSwitchPosition_switch((Switch)otherEnd, msgs);
			case RailwayPackage.SWITCH_POSITION__SWITCH_POSITION_ROUTE:
				if (switchPosition_route != null)
					msgs = ((InternalEObject)switchPosition_route).eInverseRemove(this, RailwayPackage.ROUTE__ROUTE_SWITCH_POSITION, Route.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case RailwayPackage.SWITCH_POSITION__SWITCH_POSITION_SWITCH_STATE:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case RailwayPackage.SWITCH_POSITION__SWITCH_POSITION_SWITCH:
				...
				return;
			case RailwayPackage.SWITCH_POSITION__SWITCH_POSITION_SWITCH_STATE:
				setSwitchPosition_switchState((SwitchState)newValue);
				return;
			case RailwayPackage.SWITCH_POSITION__SWITCH_POSITION_ROUTE:
