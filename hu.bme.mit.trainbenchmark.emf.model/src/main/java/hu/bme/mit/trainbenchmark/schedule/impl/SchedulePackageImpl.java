...
public class SchedulePackageImpl extends EPackageImpl implements SchedulePackage {
	 ...
	 * @generated
	 */
	private EEnum trainStatusEEnum = null;
	 ...
	 * @generated
	 */
	public EAttribute getSchedule_Transaction() {
	 ...
	 * @generated
	 */
	public EAttribute getStation_Stanox() {
	 ...
	 * @generated
	 */
	public EAttribute getStation_Nalco() {
	 ...
	 * @generated
	 */
	public EEnum getTrainStatus() {
		return trainStatusEEnum;
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(scheduleEClass, SCHEDULE__TRANSACTION);
		...
		createEAttribute(stationEClass, STATION__STANOX);
		createEAttribute(stationEClass, STATION__NALCO);
		...
		trainStatusEEnum = createEEnum(TRAIN_STATUS);
	...
	public void initializePackageContents() {
		...
		initEReference(getSchedule_Destinations(), this.getStation(), null, "destinations", null, 1, -1, Schedule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSchedule_Status(), this.getTrainStatus(), "status", null, 0, 1, Schedule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getSchedule_Transaction(), ecorePackage.getEString(), "transaction", null, 0, 1, Schedule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getSchedule_Origin(), this.getStation(), null, "origin", null, 1, 1, Schedule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSchedule_Terminal(), this.getStation(), null, "terminal", null, 1, 1, Schedule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getStation_Stanox(), ecorePackage.getEString(), "stanox", null, 1, 1, Station.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getStation_Nalco(), ecorePackage.getEString(), "nalco", null, 1, 1, Station.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEEnum(trainStatusEEnum, TrainStatus.class, "TrainStatus");
		addEEnumLiteral(trainStatusEEnum, TrainStatus.FREIGHT);
		addEEnumLiteral(trainStatusEEnum, TrainStatus.PASSENGER);
		addEEnumLiteral(trainStatusEEnum, TrainStatus.SHIP);
		addEEnumLiteral(trainStatusEEnum, TrainStatus.BUS);
		addEEnumLiteral(trainStatusEEnum, TrainStatus.TRIP);
