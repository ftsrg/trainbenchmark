...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Train Container</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link hu.bme.mit.trainbenchmark.schedule.impl.TrainContainerImpl#getTrains <em>Trains</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TrainContainerImpl extends MinimalEObjectImpl.Container implements TrainContainer {
        /**
        ...
        protected EClass eStaticClass() {
                return SchedulePackage.Literals.TRAIN_CONTAINER;
        }
        ...
        public EList<Train> getTrains() {
                if (trains == null) {
                        trains = new EObjectContainmentEList<Train>(Train.class, this, SchedulePackage.TRAIN_CONTAINER__TRAINS);
                }
                return trains;
        }
        ...
        public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
                switch (featureID) {
                        case SchedulePackage.TRAIN_CONTAINER__TRAINS:
