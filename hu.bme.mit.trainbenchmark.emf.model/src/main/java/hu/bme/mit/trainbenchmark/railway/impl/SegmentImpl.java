 ...
 * <ul>
 *   <li>{@link hu.bme.mit.trainbenchmark.railway.impl.SegmentImpl#getSegment_length <em>Segment length</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SegmentImpl extends TrackElementImpl implements Segment {
	...
	public void setSegment_length(int newSegment_length) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RailwayPackage.SEGMENT__SEGMENT_LENGTH, oldSegment_length, segment_length));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RailwayPackage.SEGMENT__SEGMENT_LENGTH:
