...
public class ScheduleSwitch<T> extends Switch<T> {
        ...
        protected T doSwitch(int classifierID, EObject theEObject) {
                switch (classifierID) {
                        case SchedulePackage.TRAIN_CONTAINER: {
                                TrainContainer trainContainer = (TrainContainer)theEObject;
                                T result = caseTrainContainer(trainContainer);
                        ...
                        case SchedulePackage.ASSOCIATION: {
        ...
        /**
         * Returns the result of interpreting the object as an instance of '<em>Train Container</em>'.
         * <!-- begin-user-doc -->
         * This implementation returns null;
         * returning a non-null result will terminate the switch.
         * <!-- end-user-doc -->
         * @param object the target of the switch.
         * @return the result of interpreting the object as an instance of '<em>Train Container</em>'.
         * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
         * @generated
         */
        public T caseTrainContainer(TrainContainer object) {
                return null;
        }
