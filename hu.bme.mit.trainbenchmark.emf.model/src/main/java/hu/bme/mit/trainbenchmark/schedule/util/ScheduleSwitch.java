...
public class ScheduleSwitch<T> extends Switch<T> {
        ...
        protected T doSwitch(int classifierID, EObject theEObject) {
                switch (classifierID) {
                        case SchedulePackage.SCHEDULE_CONTAINER: {
                                ScheduleContainer scheduleContainer = (ScheduleContainer)theEObject;
                                T result = caseScheduleContainer(scheduleContainer);
         ...
         * @generated
         */
        public T caseScheduleContainer(ScheduleContainer object) {
                return null;
        }
