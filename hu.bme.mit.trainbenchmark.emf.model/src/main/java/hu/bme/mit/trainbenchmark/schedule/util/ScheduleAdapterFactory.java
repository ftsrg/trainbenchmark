...
public class ScheduleAdapterFactory extends AdapterFactoryImpl {
        ...
        protected ScheduleSwitch<Adapter> modelSwitch =
                new ScheduleSwitch<Adapter>() {
                        @Override
                        public Adapter caseTrainContainer(TrainContainer object) {
                                return createTrainContainerAdapter();
                        }
                        @Override
        ...
        /**
         * Creates a new adapter for an object of class '{@link hu.bme.mit.trainbenchmark.schedule.TrainContainer <em>Train Container</em>}'.
         * <!-- begin-user-doc -->
         ...
         * @generated
         */
        public Adapter createTrainContainerAdapter() {
                return null;
        }
        ...
        /**
         * Creates a new adapter for an object of class '{@link hu.bme.mit.trainbenchmark.schedule.Train <em>Train</em>}'.
         * <!-- begin-user-doc -->
         * This default implementation returns null so that we can easily ignore cases;
         * it's useful to ignore a case when inheritance will catch all the cases anyway.
         * <!-- end-user-doc -->
