...
public class ScheduleFactoryImpl extends EFactoryImpl implements ScheduleFactory {
        ...
        public EObject create(EClass eClass) {
                switch (eClass.getClassifierID()) {
                        case SchedulePackage.SCHEDULE_CONTAINER: return createScheduleContainer();
         ...
         * @generated
         */
        public ScheduleContainer createScheduleContainer() {
                ScheduleContainerImpl scheduleContainer = new ScheduleContainerImpl();
