...
public class ScheduleFactoryImpl extends EFactoryImpl implements ScheduleFactory {
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			...
			case SchedulePackage.TRAIN_STATUS:
				return createTrainStatusFromString(eDataType, initialValue);
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			...
			case SchedulePackage.TRAIN_STATUS:
				return convertTrainStatusToString(eDataType, instanceValue);
			case SchedulePackage.SCHEDULE_PLANNING:
	 ...
	 * @generated
	 */
	public TrainStatus createTrainStatusFromString(EDataType eDataType, String initialValue) {
		TrainStatus result = TrainStatus.get(initialValue);
		if (result == null) throw new IllegalArgumentException("The value '" + initialValue + "' is not a valid enumerator of '" + eDataType.getName() + "'");
		return result;
	}
	 ...
	 * @generated
	 */
	public String convertTrainStatusToString(EDataType eDataType, Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
