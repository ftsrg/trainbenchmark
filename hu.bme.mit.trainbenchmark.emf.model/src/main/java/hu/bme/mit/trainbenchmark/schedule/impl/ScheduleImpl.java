 ...
 *   <li>{@link hu.bme.mit.trainbenchmark.schedule.impl.ScheduleImpl#getUid <em>Uid</em>}</li>
 *   <li>{@link hu.bme.mit.trainbenchmark.schedule.impl.ScheduleImpl#getAssociation <em>Association</em>}</li>
...
public class ScheduleImpl extends MinimalEObjectImpl.Container implements Schedule {
        ...
        public void setUid(int newUid) {
                ...
                uid = newUid;
                if (eNotificationRequired())
                        eNotify(new ENotificationImpl(this, Notification.SET, SchedulePackage.SCHEDULE__UID, oldUid, uid));
        }
        ...
        public NotificationChain basicSetAssociation(Association newAssociation, NotificationChain msgs) {
                ...
                if (eNotificationRequired()) {
                        ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SchedulePackage.SCHEDULE__ASSOCIATION, oldAssociation, newAssociation);
                        if (msgs == null) msgs = notification; else msgs.add(notification);
                }
                return msgs;
        }
        ...
        public void setAssociation(Association newAssociation) {
                if (newAssociation != association) {
                        NotificationChain msgs = null;
                        if (association != null)
                                msgs = ((InternalEObject)association).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SchedulePackage.SCHEDULE__ASSOCIATION, null, msgs);
                        if (newAssociation != null)
                                msgs = ((InternalEObject)newAssociation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SchedulePackage.SCHEDULE__ASSOCIATION, null, msgs);
                        msgs = basicSetAssociation(newAssociation, msgs);
                        if (msgs != null) msgs.dispatch();
                }
                else if (eNotificationRequired())
                        eNotify(new ENotificationImpl(this, Notification.SET, SchedulePackage.SCHEDULE__ASSOCIATION, newAssociation, newAssociation));
        }
        ...
        public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
                switch (featureID) {
                        ...
                        case SchedulePackage.SCHEDULE__ASSOCIATION:
        ...
        public Object eGet(int featureID, boolean resolve, boolean coreType) {
                switch (featureID) {
                        ...
                        case SchedulePackage.SCHEDULE__TERMINAL:
                                return getTerminal();
                        case SchedulePackage.SCHEDULE__UID:
                                return getUid();
                        case SchedulePackage.SCHEDULE__ASSOCIATION:
