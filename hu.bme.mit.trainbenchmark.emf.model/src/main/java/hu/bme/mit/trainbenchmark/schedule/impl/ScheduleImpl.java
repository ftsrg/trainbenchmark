 ...
 *   <li>{@link hu.bme.mit.trainbenchmark.schedule.impl.ScheduleImpl#getTransaction <em>Transaction</em>}</li>
...
public class ScheduleImpl extends MinimalEObjectImpl.Container implements Schedule {
	 ...
	 * @ordered
	 */
	protected static final TrainStatus STATUS_EDEFAULT = TrainStatus.FREIGHT;
	 ...
	 * @ordered
	 */
	protected TrainStatus status = STATUS_EDEFAULT;
	 ...
	 * @generated
	 */
	public void setStatus(TrainStatus newStatus) {
	...
	public void setTransaction(String newTransaction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchedulePackage.SCHEDULE__TRANSACTION, oldTransaction, transaction));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case SchedulePackage.SCHEDULE__START_DATE:
				return getStartDate();
			case SchedulePackage.SCHEDULE__TRANSACTION:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case SchedulePackage.SCHEDULE__DESTINATIONS:
				...
				return;
			case SchedulePackage.SCHEDULE__STATUS:
				setStatus((TrainStatus)newValue);
				return;
			case SchedulePackage.SCHEDULE__START_DATE:
