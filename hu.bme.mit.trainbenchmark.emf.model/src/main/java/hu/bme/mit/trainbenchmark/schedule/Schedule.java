 ...
 *   <li>{@link hu.bme.mit.trainbenchmark.schedule.Schedule#getUid <em>Uid</em>}</li>
 *   <li>{@link hu.bme.mit.trainbenchmark.schedule.Schedule#getAssociation <em>Association</em>}</li>
...
public interface Schedule extends EObject {
         ...
         * @see #setUid(int)
         * @see hu.bme.mit.trainbenchmark.schedule.SchedulePackage#getSchedule_Uid()
        ...
        /**
         * Sets the value of the '{@link hu.bme.mit.trainbenchmark.schedule.Schedule#getUid <em>Uid</em>}' attribute.
         * <!-- begin-user-doc -->
         * <!-- end-user-doc -->
         ...
         * @see hu.bme.mit.trainbenchmark.schedule.SchedulePackage#getSchedule_Association()
         * @model containment="true"
         * @generated
         */
        ...
        /**
         * Sets the value of the '{@link hu.bme.mit.trainbenchmark.schedule.Schedule#getAssociation <em>Association</em>}' containment reference.
         * <!-- begin-user-doc -->
         * <!-- end-user-doc -->
