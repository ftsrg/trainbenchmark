 ...
 * <ul>
 *   <li>{@link hu.bme.mit.trainbenchmark.railway.impl.SensorImpl#getSensor_trackElement <em>Sensor track Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SensorImpl extends RailwayElementImpl implements Sensor {
	...
	public EList<TrackElement> getSensor_trackElement() {
		if (sensor_trackElement == null) {
			sensor_trackElement = new EObjectWithInverseResolvingEList.ManyInverse<TrackElement>(TrackElement.class, this, RailwayPackage.SENSOR__SENSOR_TRACK_ELEMENT, RailwayPackage.TRACK_ELEMENT__TRACK_ELEMENT_SENSOR);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RailwayPackage.SENSOR__SENSOR_TRACK_ELEMENT:
