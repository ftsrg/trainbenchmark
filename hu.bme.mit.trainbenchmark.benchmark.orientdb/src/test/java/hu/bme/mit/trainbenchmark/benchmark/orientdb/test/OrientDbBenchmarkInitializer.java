...
import hu.bme.mit.trainbenchmark.benchmark.orientdb.OrientDbBenchmarkCase;
import hu.bme.mit.trainbenchmark.benchmark.scenarios.BenchmarkLogic;
import hu.bme.mit.trainbenchmark.benchmark.test.TestBenchmarkInitializer;
import hu.bme.mit.trainbenchmark.constants.Query;
import hu.bme.mit.trainbenchmark.constants.Scenario;

public class OrientDbBenchmarkInitializer extends TestBenchmarkInitializer {
	...
	protected BenchmarkLogic initializeBenchmark(final Query query, final Scenario scenario) {
		...
		return new BenchmarkLogic(bc, new OrientDbBenchmarkCase());
	}
