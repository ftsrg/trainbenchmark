...
public class TinkerGraphSwitchMonitoredInjectMatch extends TinkerGraphMatch implements SwitchMonitoredInjectMatch {

	public TinkerGraphSwitchMonitoredInjectMatch(final Map<String, Object> match) {
		super(match);
	}
