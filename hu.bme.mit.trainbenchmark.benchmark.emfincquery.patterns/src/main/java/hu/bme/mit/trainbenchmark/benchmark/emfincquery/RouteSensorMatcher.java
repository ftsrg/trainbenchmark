...
public class RouteSensorMatcher extends BaseMatcher<RouteSensorMatch> {
   ...
   * 
   */
  public Collection<RouteSensorMatch> getAllMatches(final Sensor pSen) {
    return rawGetAllMatches(new Object[]{pSen});
  }
   ...
   * 
   */
  public RouteSensorMatch getOneArbitraryMatch(final Sensor pSen) {
    return rawGetOneArbitraryMatch(new Object[]{pSen});
  }
   ...
   * 
   */
  public boolean hasMatch(final Sensor pSen) {
    return rawHasMatch(new Object[]{pSen});
  }
   ...
   * 
   */
  public int countMatches(final Sensor pSen) {
    return rawCountMatches(new Object[]{pSen});
  }
   ...
   * 
   */
  public void forEachMatch(final Sensor pSen, final IMatchProcessor<? super RouteSensorMatch> processor) {
    rawForEachMatch(new Object[]{pSen}, processor);
  }
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Sensor pSen, final IMatchProcessor<? super RouteSensorMatch> processor) {
    return rawForOneArbitraryMatch(new Object[]{pSen}, processor);
  }
   ...
   */
  @Deprecated
  public DeltaMonitor<RouteSensorMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final Sensor pSen) {
    return rawNewFilteredDeltaMonitor(fillAtStart, new Object[]{pSen});
  }
   ...
   * 
   */
  public RouteSensorMatch newMatch(final Sensor pSen) {
    return RouteSensorMatch.newMatch(pSen);
  ...
  protected RouteSensorMatch tupleToMatch(final Tuple t) {
    try {
      return RouteSensorMatch.newMatch((Concept.Sensor) t.get(POSITION_SEN));
  ...
  protected RouteSensorMatch arrayToMatch(final Object[] match) {
    try {
      return RouteSensorMatch.newMatch((Concept.Sensor) match[POSITION_SEN]);
    } catch(ClassCastException e) {
  ...
  protected RouteSensorMatch arrayToMatchMutable(final Object[] match) {
    try {
      return RouteSensorMatch.newMutableMatch((Concept.Sensor) match[POSITION_SEN]);
    } catch(ClassCastException e) {
      LOGGER.error("Element(s) in array not properly typed!",e);
      return null;
    }
