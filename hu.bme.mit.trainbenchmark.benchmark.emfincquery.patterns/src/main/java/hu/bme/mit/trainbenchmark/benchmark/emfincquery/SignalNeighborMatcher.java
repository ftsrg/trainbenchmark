...
public class SignalNeighborMatcher extends BaseMatcher<SignalNeighborMatch> {
   ...
   * 
   */
  public Collection<SignalNeighborMatch> getAllMatches(final Route pR1) {
    return rawGetAllMatches(new Object[]{pR1});
  }
   ...
   * 
   */
  public SignalNeighborMatch getOneArbitraryMatch(final Route pR1) {
   ...
   * 
   */
  public boolean hasMatch(final Route pR1) {
   ...
   * 
   */
  public int countMatches(final Route pR1) {
   ...
   * 
   */
  public void forEachMatch(final Route pR1, final IMatchProcessor<? super SignalNeighborMatch> processor) {
    rawForEachMatch(new Object[]{pR1}, processor);
  }
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Route pR1, final IMatchProcessor<? super SignalNeighborMatch> processor) {
   ...
   */
  @Deprecated
  public DeltaMonitor<SignalNeighborMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final Route pR1) {
    return rawNewFilteredDeltaMonitor(fillAtStart, new Object[]{pR1});
  }
   ...
   * 
   */
  public SignalNeighborMatch newMatch(final Route pR1) {
    return SignalNeighborMatch.newMatch(pR1);
  ...
  protected SignalNeighborMatch tupleToMatch(final Tuple t) {
    try {
      return SignalNeighborMatch.newMatch((Concept.Route) t.get(POSITION_R1));
  ...
  protected SignalNeighborMatch arrayToMatch(final Object[] match) {
    try {
      return SignalNeighborMatch.newMatch((Concept.Route) match[POSITION_R1]);
    } catch(ClassCastException e) {
  ...
  protected SignalNeighborMatch arrayToMatchMutable(final Object[] match) {
    try {
      return SignalNeighborMatch.newMutableMatch((Concept.Route) match[POSITION_R1]);
    } catch(ClassCastException e) {
      LOGGER.error("Element(s) in array not properly typed!",e);
      return null;
    }
