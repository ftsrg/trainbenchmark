...
public abstract class ExitSignalMatch extends BasePatternMatch {
  ...
  private ExitSignalMatch(final Route pR, final Signal pSig) {
    this.fR = pR;
    this.fSig = pSig;
   ...
   * 
   */
  public static ExitSignalMatch newMutableMatch(final Route pR, final Signal pSig) {
   ...
   * 
   */
  public static ExitSignalMatch newMatch(final Route pR, final Signal pSig) {
