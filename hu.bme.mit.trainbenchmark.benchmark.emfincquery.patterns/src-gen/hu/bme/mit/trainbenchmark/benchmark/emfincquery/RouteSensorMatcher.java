...
public class RouteSensorMatcher extends BaseMatcher<RouteSensorMatch> {
  ...
  protected RouteSensorMatch tupleToMatch(final Tuple t) {
    try {
    	return RouteSensorMatch.newMatch((hu.bme.mit.trainbenchmark.railway.Route) t.get(POSITION_ROUTE), (hu.bme.mit.trainbenchmark.railway.Sensor) t.get(POSITION_SENSOR), (hu.bme.mit.trainbenchmark.railway.SwitchPosition) t.get(POSITION_SWITCHPOSITION), (hu.bme.mit.trainbenchmark.railway.Switch) t.get(POSITION_SW));
  ...
  protected RouteSensorMatch arrayToMatch(final Object[] match) {
    try {
    	return RouteSensorMatch.newMatch((hu.bme.mit.trainbenchmark.railway.Route) match[POSITION_ROUTE], (hu.bme.mit.trainbenchmark.railway.Sensor) match[POSITION_SENSOR], (hu.bme.mit.trainbenchmark.railway.SwitchPosition) match[POSITION_SWITCHPOSITION], (hu.bme.mit.trainbenchmark.railway.Switch) match[POSITION_SW]);
    } catch(ClassCastException e) {
  ...
  protected RouteSensorMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return RouteSensorMatch.newMutableMatch((hu.bme.mit.trainbenchmark.railway.Route) match[POSITION_ROUTE], (hu.bme.mit.trainbenchmark.railway.Sensor) match[POSITION_SENSOR], (hu.bme.mit.trainbenchmark.railway.SwitchPosition) match[POSITION_SWITCHPOSITION], (hu.bme.mit.trainbenchmark.railway.Switch) match[POSITION_SW]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
