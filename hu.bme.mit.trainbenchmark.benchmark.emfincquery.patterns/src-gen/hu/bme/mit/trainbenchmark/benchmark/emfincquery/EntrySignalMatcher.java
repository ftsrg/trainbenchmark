...
public class EntrySignalMatcher extends BaseMatcher<EntrySignalMatch> {
   ...
   * 
   */
  public Collection<EntrySignalMatch> getAllMatches(final Route pRoute, final Signal pSignal) {
   ...
   * 
   */
  public EntrySignalMatch getOneArbitraryMatch(final Route pRoute, final Signal pSignal) {
   ...
   * 
   */
  public void forEachMatch(final Route pRoute, final Signal pSignal, final IMatchProcessor<? super EntrySignalMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Route pRoute, final Signal pSignal, final IMatchProcessor<? super EntrySignalMatch> processor) {
   ...
   * 
   */
  public EntrySignalMatch newMatch(final Route pRoute, final Signal pSignal) {
    return EntrySignalMatch.newMatch(pRoute, pSignal);
  }
   ...
   * 
   */
  public Set<Route> getAllValuesOfroute(final EntrySignalMatch partialMatch) {
   ...
   * 
   */
  public Set<Signal> getAllValuesOfsignal(final EntrySignalMatch partialMatch) {
  ...
  protected EntrySignalMatch tupleToMatch(final Tuple t) {
    try {
    	return EntrySignalMatch.newMatch((hu.bme.mit.trainbenchmark.railway.Route) t.get(POSITION_ROUTE), (hu.bme.mit.trainbenchmark.railway.Signal) t.get(POSITION_SIGNAL));
  ...
  protected EntrySignalMatch arrayToMatch(final Object[] match) {
    try {
    	return EntrySignalMatch.newMatch((hu.bme.mit.trainbenchmark.railway.Route) match[POSITION_ROUTE], (hu.bme.mit.trainbenchmark.railway.Signal) match[POSITION_SIGNAL]);
    } catch(ClassCastException e) {
  ...
  protected EntrySignalMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return EntrySignalMatch.newMutableMatch((hu.bme.mit.trainbenchmark.railway.Route) match[POSITION_ROUTE], (hu.bme.mit.trainbenchmark.railway.Signal) match[POSITION_SIGNAL]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
