...
public abstract class EntrySignalMatch extends BasePatternMatch {
  ...
  private EntrySignalMatch(final Route pRoute, final Signal pSignal) {
    this.fRoute = pRoute;
   ...
   * 
   */
  public static EntrySignalMatch newMutableMatch(final Route pRoute, final Signal pSignal) {
   ...
   * 
   */
  public static EntrySignalMatch newMatch(final Route pRoute, final Signal pSignal) {
