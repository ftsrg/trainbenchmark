...
/**
 * A pattern group formed of all patterns defined in SwitchMonitored.eiq.
 * 
 * <p>Use the static instance as any {@link org.eclipse.incquery.runtime.api.IPatternGroup}, to conveniently prepare
 * an EMF-IncQuery engine for matching all patterns originally defined in file SwitchMonitored.eiq,
...
public final class SwitchMonitored extends BaseGeneratedPatternGroup {
   ...
   * 
   */
  public static SwitchMonitored instance() throws IncQueryException {
    if (INSTANCE == null) {
  ...
  private SwitchMonitored() throws IncQueryException {
