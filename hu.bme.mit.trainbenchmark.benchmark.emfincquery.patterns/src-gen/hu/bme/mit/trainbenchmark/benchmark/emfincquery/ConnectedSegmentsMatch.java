...
public abstract class ConnectedSegmentsMatch extends BasePatternMatch {
  ...
  private ConnectedSegmentsMatch(final Segment pSegment) {
   ...
   * 
   */
  public static ConnectedSegmentsMatch newMutableMatch(final Segment pSegment) {
   ...
   * 
   */
  public static ConnectedSegmentsMatch newMatch(final Segment pSegment) {
