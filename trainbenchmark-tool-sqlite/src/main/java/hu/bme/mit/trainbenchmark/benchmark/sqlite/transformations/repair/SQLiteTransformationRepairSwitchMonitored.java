...
public class SQLiteTransformationRepairSwitchMonitored extends SQLiteTransformationRepair<SqlSwitchMonitoredMatch> {
	...
	public SQLiteTransformationRepairSwitchMonitored(final SQLiteDriver driver, final BenchmarkConfig benchmarkConfig, final RailwayQuery query) throws IOException {
