...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.trainbenchmark.railway.Segment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SegmentItemProvider extends TrackElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Segment_length_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Segment_length_feature", "_UI_Segment_type"),
				 RailwayPackage.Literals.SEGMENT__LENGTH,
				 true,
				 false,
				 false,
