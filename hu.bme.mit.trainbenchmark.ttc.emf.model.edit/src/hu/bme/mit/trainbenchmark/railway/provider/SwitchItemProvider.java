...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.trainbenchmark.railway.Switch} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SwitchItemProvider extends TrackElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Switch_currentPosition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Switch_currentPosition_feature", "_UI_Switch_type"),
				 RailwayPackage.Literals.SWITCH__CURRENT_POSITION,
				 true,
				 false,
				 false,
	...
	protected void addPositionsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Switch_positions_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Switch_positions_feature", "_UI_Switch_type"),
				 RailwayPackage.Literals.SWITCH__POSITIONS,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Switch_type") + " " + switch_.getId();
	}
