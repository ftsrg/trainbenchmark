...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.trainbenchmark.railway.Semaphore} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SemaphoreItemProvider extends RailwayElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Semaphore_signal_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Semaphore_signal_feature", "_UI_Semaphore_type"),
				 RailwayPackage.Literals.SEMAPHORE__SIGNAL,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Semaphore_type") + " " + semaphore.getId();
	}
